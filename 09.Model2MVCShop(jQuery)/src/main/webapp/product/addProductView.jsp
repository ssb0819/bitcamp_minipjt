...
$(function(){
	...
	$('#deleteFile').on('click',function(){
		$('input[name="uploadFile"]').eq(0).val('');
	});
	
	$('#addFile').on('click',function(){
		
		var addFile = "<tr><td class='ct_write01'>"
						+"<input type='file' class='form-control-file border'"
						+"name='uploadFile' multiple='multiple'>"
						+"<input type='button' value='삭제' onClick='javascript:removeFile(this);' />"
						+"</td></tr>";
		
		$('#addedFile').append(addFile);
		console.log(addFile);
	});
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<input type="button" id="deleteFile" value="파일삭제" />
